...
It may not be our final design, but it's a much better place to start than a blank CSS file.
:::
...
We choose a preset Bootswatch theme and pass it to the page.
...
The New York Times is a useful example. Their visualizations can use very different palettes, but the recurring title typeface Cheltenham helps them remain recognizable.

They still create hierarchy and variety by using different styles from the same typeface across titles, labels, and supporting text.
...
And when we define both in one reusable place, we don't have to recreate that identity one product at a time.
:::
...
![](inst/img/talk-page-qr.png){.absolute height="50%"}
